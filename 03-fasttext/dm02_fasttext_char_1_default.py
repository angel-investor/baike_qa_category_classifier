...
# 1、模型训练
model = fasttext.train_supervised(input=conf.process_dev_datapath_char_simple,
...
# 3、模型预测
print(model.predict("嘴 群 里 有 许 多 硬 结 是 啥   嘴 群 里 有 许 多 硬 结 是 啥"))
